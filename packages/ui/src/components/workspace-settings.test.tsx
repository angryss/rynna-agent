...
it('updates the default directory and creates, edits, and deletes named workspaces', async () => {
  ...
  function Harness() {
    ...
    return <WorkspaceSettings client={client} onSaved={setProfile} profile={profile} />;
  }
  ...
  expect(screen.getByText(/No named workspaces yet/)).toBeInTheDocument();
});
